...
#define spi_readwrite spi_instance->transfer
...
{
    spi_instance->beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
void MCP_CAN::setSpiInstance(SPIClass *instance)
{
